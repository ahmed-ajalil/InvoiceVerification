$(document).ready(function () {
    var _lableIndustry = "GPT-4o Model";
    ...
    $("#hyperInputDiv").val("Assistant is an intelligent chatbot designed to help users answer their Banking related questions." +
        "Instructions:" + "-Only answer questions related to Banking." + "-If you're unsure of an answer, you can say I don't know or I'm not sure and recommend users go to the Banking documentation for more information.");
});
